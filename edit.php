...
$sql = "SELECT * FROM list WHERE link='".$link."'";
...
<center>
    <br/>
    <center><h1><font face="Century Gothic" size="6">Edit record</font></h1></center>
    <br/>
    <form style="width: 50%" action="/edit-action.php" method="post">
        <div class="form-group">
            <label for="link">Link</label>
            <input type="text" class="form-control" id="link" name="link" value="<?php echo $link?>" style="text-align: center" readonly>
        </div>
        <div class="form-group">
            <label for="chname">Channel Name</label>
            <input type="text" class="form-control" id="chname" name="chname" value="<?php echo $cname?>" placeholder="Insert the Channel Name" style="text-align: center">
        </div>
        <div class="form-group">
            ...
            <select class="form-control" id="reported" name="reported">
                ...
                if($reported == 0){
                    ...
                    echo '<option value="2" selected="selected">Yes</option>';
                }
                ?>
            </select>
        </div>
        <div class="form-group">
            ...
            <select class="form-control" id="solved" name="solved">
                <?php
                    if($solved == "not yet"){
                        echo '<option value="0"></option>';
                        echo '<option value="1" selected="selected">Not Yet</option>';
                        echo '<option value="2">No</option>';
                        echo '<option value="3">Yes</option>';
                    }elseif($solved == "no"){
                        echo '<option value="0"></option>';
                        echo '<option value="1">Not Yet</option>';
                        ...
                        echo '<option value="1">Not Yet</option>';
                        echo '<option value="2">No</option>';
                        echo '<option value="3" selected="selected">Yes</option>';
                    }
                ?>
            </select>
        </div>
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="reporter" name="reporter" value="<?php echo $reporter?>" placeholder="Insert the Reporter Name" style="text-align: center">
        </div>
